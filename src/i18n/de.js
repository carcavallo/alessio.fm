export const de = {
  ...
  about: {
    ...
    bio1: 'Mit {age} Jahren habe ich meine Lehre als Applikationsentwickler abgeschlossen und arbeite heute als Site Reliability Engineer bei der',
    bio2: '. Neben meiner Haupttätigkeit bin ich aktiver Daytrader und Co-Founder von',
    bio3: '— einer Trading-Community für ambitionierte Trader.',
    sre: 'Site Reliability Engineering:',
    sreDesc: 'Überwachung, Wartung und Migration komplexer IT-Infrastrukturen. Automatisierung mit Ansible, Monitoring und Incident Response. Expertise in Linux, Docker, Kubernetes und Cloud-Infrastrukturen.',
    trading: 'Trading:',
    tradingDesc: 'Aktiver Daytrader mit Fokus auf US-Indizes (Nasdaq, S&P 500) und Gold. Trading-Stil basiert auf ICT/SMC-Konzepten — Liquidity Sweeps, Order Blocks, Fair Value Gaps.',
    entrepreneurship: 'Entrepreneurship:',
    entrepreneurshipDesc: 'Aufbau von Alpin Signals als Trading-Community mit automatisierten Marktanalysen, Telegram-Bot und Coaching-Angeboten.',
    stats: {
  ...
  contact: {
    ...
    form: {
      ...
      success: 'Nachricht gesendet! Ich melde mich innerhalb von 24h bei dir.',
      error: 'Etwas ist schiefgelaufen. Bitte versuche es nochmal oder schreib direkt an me@alessio.fm',
    },
