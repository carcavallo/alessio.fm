  ...
  <div style="background:#050816;padding:40px 20px;font-family:'Helvetica Neue',Arial,sans-serif;">
    <div style="max-width:600px;margin:0 auto;">
      <div style="text-align:center;padding:24px 0;font-size:24px;font-weight:800;letter-spacing:2px;color:#fff;">
        &lt;/&gt; <span style="color:#0EA5E9;">alessio.fm</span>
      </div>
      <div style="height:2px;background:linear-gradient(90deg,transparent,#0EA5E9,transparent);margin:0 40px;"></div>
      <div style="background:#0d0a1a;border-radius:12px;border:1px solid rgba(14,165,233,0.15);padding:40px;margin-top:32px;">
        <h1 style="margin:0 0 8px;font-size:24px;font-weight:800;color:#fff;">Neue Anfrage 📩</h1>
        <p style="margin:0 0 24px;font-size:14px;color:#38BDF8;font-weight:600;letter-spacing:1px;">${service || 'Allgemein'}</p>
        <div style="background:#050816;border-radius:8px;padding:20px;margin:16px 0;">
          <p style="margin:0 0 8px;font-size:13px;color:#38BDF8;font-weight:700;">VON</p>
        ...
        <div style="background:#050816;border-radius:8px;padding:20px;margin:16px 0;">
          <p style="margin:0 0 8px;font-size:13px;color:#38BDF8;font-weight:700;">NACHRICHT</p>
          <p style="margin:0;font-size:15px;color:#e0e0e0;line-height:1.7;white-space:pre-wrap;">${message}</p>
        </div>
        <a href="mailto:${email}" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#0EA5E9;color:#fff;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px;">Antworten →</a>
      </div>
    </div>
  </div>`;
}
  ...
  <div style="background:#050816;padding:40px 20px;font-family:'Helvetica Neue',Arial,sans-serif;">
    <div style="max-width:600px;margin:0 auto;">
      ...
      <div style="background:#0d0a1a;border-radius:12px;border:1px solid rgba(14,165,233,0.15);padding:40px;margin-top:32px;">
        ...
        ${service ? `<p style="margin:0 0 24px;font-size:14px;color:#38BDF8;font-weight:600;letter-spacing:1px;">${service}</p>` : ''}
